...
fn main() {
    let n: usize = 100;
    let (x_base, _): (Vec<f64>, Option<usize>) = Array::linspace(-10., 10., n).into_raw_vec_and_offset();
    let (y_base, _): (Vec<f64>, Option<usize>) = Array::linspace(-10., 10., n).into_raw_vec_and_offset();
